...
export default function EmployeeHome() {
  const [Links, setLinks] = useState(<h1>Welcom to Rupani Online Bank</h1>);
  ...
  return (
    <div>
      ...
      Rupani Foundation’s mission is to create long lasting solutions to poverty by enhancing 
      skills through value addition in local resources and 
      promote holistic development of children by providing educational and ECD services.
      </Footer>
    </div>
  );
}
